...
class SolarEnergyProduction extends StatefulWidget {
  ...
  @override
  State<SolarEnergyProduction> createState() => _SolarEnergyProductionState();
}

class _SolarEnergyProductionState extends State<SolarEnergyProduction> {
  @override
